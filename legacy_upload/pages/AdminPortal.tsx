...
const AdminPortal: React.FC = () => {
    ...
    const getPageTitle = () => {
        ...
        if (path.includes('/shortlist-requests')) return 'Shortlist Requests';
    ...
    return (
        <PortalLayout pageTitle={getPageTitle()}>
            <Routes>
                ...
                <Route path="organizations" element={<OrgsView />} />
                <Route path="jobs" element={<JobsView />} />
                <Route path="candidates" element={<CandidatesView />} />
                <Route path="shortlist-requests" element={<ShortlistRequestsView />} />
